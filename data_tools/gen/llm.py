...
_AUDIT_SYSTEM_TEMPLATE = (
    ...
    "- LONE COMPONENT -> full name: if a form has a single given-name OR a single "
    "family-name with NO complementary component anywhere on the form (no partner "
    "family-name / given-name field), that field is almost certainly a full-name "
    "box that was mislabeled -- suggest 'name'. A first-name-only newsletter is the "
    "rare exception; answer 'unsure' if the label literally says only 'first' or "
    "'last' name. The same applies to a lone phonetic-given-name / "
    "phonetic-family-name without its partner.\n"
